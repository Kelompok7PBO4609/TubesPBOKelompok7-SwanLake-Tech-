package com.tubes.swanlake_tech_backend.config;

import com.tubes.swanlake_tech_backend.service.AccountDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request-> request.requestMatchers("/auth/**", "/public/**").permitAll()
                        ...
                        .requestMatchers("/put/review/**").permitAll()
                        .requestMatchers("/get/account/**").permitAll()
                        .requestMatchers("/put/account/**").permitAll()
