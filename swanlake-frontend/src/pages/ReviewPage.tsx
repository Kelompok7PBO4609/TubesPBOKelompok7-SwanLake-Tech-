                        ...
                        <div className="p-6">
                            ...
                            <div className="prose dark:prose-invert max-w-none">
                                <p className="text-gray-600 dark:text-gray-300 mb-6">
                                    The iPhone 15 Pro Max represents Apple's most ambitious smartphone yet,
                                    featuring groundbreaking innovations in camera technology, performance,
                                    and design. With its titanium frame and A17 Pro chip, it sets new
                                    standards for what a flagship phone can be.
                                </p>
                                ...
                                <h2 className="text-2xl font-bold dark:text-white mb-4">Performance</h2>
                                <p className="text-gray-600 dark:text-gray-300 mb-6">
                                    The A17 Pro chip delivers unprecedented performance, handling complex
                                    tasks and gaming with ease. Our benchmarks show up to 20% improvement
                                    in CPU performance and 30% in GPU tasks compared to the previous generation.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <span className="text-xl font-bold text-green-600 dark:text-green-400">$999</span>
                            </div>
                            <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div>
                                    <h4 className="font-semibold dark:text-white">Best Buy</h4>
                                    <span className="text-gray-500 dark:text-gray-400">Store pickup</span>
                                </div>
                                <span className="text-xl font-bold text-green-600 dark:text-green-400">$999</span>
                            </div>
                            <div className="flex justify-between items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <div>
                                    <h4 className="font-semibold dark:text-white">Apple Store</h4>
                                    <span className="text-gray-500 dark:text-gray-400">Free shipping</span>
                                </div>
                                <span className="text-xl font-bold text-green-600 dark:text-green-400">$999</span>
                            </div>
