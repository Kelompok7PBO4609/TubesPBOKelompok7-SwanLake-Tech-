            ...
            <div className="space-y-4">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">6-core CPU with 2 performance and 4 efficiency cores</p>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">ProMotion technology with adaptive refresh rate up to 120Hz</p>
                    </div>
                </div>
